...
class DenseNet(nn.Module):
    def __init__(self, nInputChannels, nClasses, growthRate=12, depth=100, reduction=0.5, bottleneck=True):
        ...
        self.conv1 = nn.Conv1d(nInputChannels, nChannels, kernel_size=3, padding=1,
                               bias=False)
    ...
    def forward(self, x):
        ...
        out = torch.squeeze(self.avg_pool(F.relu(self.bn1(out))))
        out = self.fc(out)
        return out